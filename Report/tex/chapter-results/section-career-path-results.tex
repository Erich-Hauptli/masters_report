...
\subsection{Node Vertex Results}
In the node vertex object, an array of node vertices is returned.  Each element
...
vertices flowing in the reverse direction.
...
clear from the vertices, but by looking at the data in the returned object, the
...
engineer.  From the node vertices it is clear that not all system chief
