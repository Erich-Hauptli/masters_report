...
is far too long to be suitable for an interactive request.  The Weka request
would have to be an option that a user specifically requests in addition to what ProGENitor
