...
to generate the vertex groupings.  These groupings can then be fed to the end user
interface to order the vertices in a fashion that shows the typical flow of
careers that reach the destination goal.
