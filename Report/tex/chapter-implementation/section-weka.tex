...
% -------------------------------------------------
% Start by placing the nodes
\node [proc, densely dotted, it] (p0) {Set \# of\newline Clusters to 1};
% Use join to connect a node to the previous one 
...
Instance}; 
\node [proc, join] (p4) {Log Likelyhood Averaged Over All 10 Runs};
\node [test, join] (p5) {IF Log Likelyhood Has Increased, Increment Clusters by
1};
