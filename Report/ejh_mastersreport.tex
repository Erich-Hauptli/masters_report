...
vast amounts of data is presented.  The algorithms developed to do this analysis
will be shown and a reference implementation will be discussed. Finally, the
results will be used to demonstrate the actionable data that is provided to the end user.
\index{Abstract}%
\indent
