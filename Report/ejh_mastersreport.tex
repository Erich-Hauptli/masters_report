...
I would like to first and foremost thank Dr. Aziz for supervising my Master's
report.  He has helped push me into areas I never though I'd venture and I
...
I'd like to thank Will O'Donnel for taking the effort out of Latex.  Finally I'd
like to thank all of my many co-workers who have helped me along the way through
the many years of my working towards my Master's degree.
\end{acknowledgments}
...
%
\utabstract
It seems these days all applications collect data and apply analytics on that
data to provide a means to better market products to consumers.  Rarely is this
data applied in a fashion to assist individuals in bettering their lives. 
Companies such as LinkedIN collect vast amounts of data surrounding an
individual’s career and this report proposes a method of using that type of data
to benefit those individuals.  Through analysis of the collected data, this report
describes a method to provide insights into what actions would have the most
benefit to achieving a specific career goal.  A Java based proof-of-concept
application will demonstrate career mapping and make conclusions on the
importance of points to achieving a specified career goal.
\index{Abstract}%
\indent
...
\include{tex/chapter-architecture}
